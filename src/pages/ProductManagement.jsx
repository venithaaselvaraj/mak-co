  ...
  async function fetchProducts() {
    try {
      ...
      const demoData = [
        ...
        { id: '3', productName: 'Lord Venkateswara Swamy Peethambaram Vastram', fabricType: 'Pure Silk', category: 'Deity Attire', color: 'Lordly Gold & Deep Yellow', manufacturerName: 'Kumbakonam Silks', price: 24500, stockQuantity: 5, imageUrl: '/assets/landing/hero_kanchipuram_silk_1774528784605.png', name: 'Swamy Peethambaram Vastram', description: 'Magnificent heavy-weight silk drape decorated with intricate motifs, customized for temple Swamy statues.' },
        { id: '4', productName: 'Temple Utsavar Deity Silk Pavadai Vastram Set', fabricType: 'Pure Silk', category: 'Deity Attire', color: 'Crimson Red & Mustard Gold', manufacturerName: 'Heritage Weaves', price: 15500, stockQuantity: 8, imageUrl: '/assets/products/banarasi.png', name: 'Temple Deity Pavadai Set', description: 'Exquisite silk micro-woven pavadai drape tailored for temple deity idol alankaram.' },
        { id: '5', productName: 'Goddess Mahalakshmi Idol Traditional Silk Saree', fabricType: 'Pure Silk', category: 'Deity Attire', color: 'Auspicious Red & Gold Zari', manufacturerName: 'Varanasi Looms', price: 22000, stockQuantity: 6, imageUrl: '/assets/products/kanchipuram.png', name: 'Goddess Laxmi Silk Saree', description: 'Splendid traditional silk saree designed for the sacred decoration and draping of Goddess temple statues.' },
        { id: '6', productName: 'Traditional Vedic Gurukul Cotton Veshti Set', fabricType: 'Pure Cotton', category: 'Vasti (Dhoti)', color: 'Sacred Cream / Off-White', manufacturerName: 'Salem Handlooms', price: 1200, stockQuantity: 60, imageUrl: '/assets/products/dhoti_border.png', name: 'Vedic Gurukul Cotton Veshti', description: 'Traditional unbleached single cotton Veshti with narrow maroon borders, designed for temple daily archana.' },
        { id: '7', productName: 'Brahminical Grahapravesam Silk Madisar Saree', fabricType: 'Pure Silk', category: 'Madisar', color: 'Deep Peacock Green & Orange', manufacturerName: 'Tanjore Artisans', price: 19800, stockQuantity: 10, imageUrl: '/assets/products/madisar.png', name: 'Grahapravesam Silk Madisar', description: '9-yard pure mulberry silk saree worn traditionally for Brahmin weddings and Grihapravesam rituals.' },
        { id: '8', productName: 'Swamy Deity Brass Alankaram Shringa Vasti', fabricType: 'Tissue Silk', category: 'Deity Attire', color: 'Solid Shimmering Gold', manufacturerName: 'Himalayan Weaves', price: 16500, stockQuantity: 4, imageUrl: '/assets/landing/traditional_ghoti_vasti_1774528814547.png', name: 'Deity Brass Alankaram Vasti', description: 'Fine metallic gold tissue Veshti designed to drape brass temple deity statues during festival processions.' },
        { id: '9', productName: 'Premium Pure Silk Angavastram for Temple Priests', fabricType: 'Pure Silk', category: 'Angavastram', color: 'Sacred Sandalwood & Gold', manufacturerName: 'Kanchi Heritage', price: 6500, stockQuantity: 15, imageUrl: '/assets/products/angavastram.png', name: 'Priests Pure Silk Angavastram', description: 'Premium sandalwood silk shoulder-wrap with ornate peacock motifs, perfect for high-ranking archakas.' },
